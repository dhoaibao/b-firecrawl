...
export default function AuditDetailDrawer({
  ...
  const statusVariant =
    entry.status_code >= 500 ? "destructive" : entry.status_code >= 400 ? "warning" : "success";
  ...
  return (
    ...
    >
      ...
      <aside
        ref={drawerRef}
        className="relative flex h-full w-full max-w-xl flex-col border-l border-white/[0.08] bg-surface-1 shadow-[var(--shadow-modal)] animate-slide-in-right"
      >
