  ...
  const barMeta = [
    {
      key: "<500ms",
      label: "<500ms",
      gradient: "bg-gradient-to-r from-success/40 to-success",
      text: "text-success-fg",
    },
    {
      key: "500ms-1s",
      label: "500ms-1s",
      gradient: "bg-gradient-to-r from-info/40 to-info",
      text: "text-info-fg",
    },
    {
      key: "1s-2s",
      label: "1s-2s",
      gradient: "bg-gradient-to-r from-warning/40 to-warning",
      text: "text-warning-fg",
    },
    {
      key: "2s-5s",
      label: "2s-5s",
      gradient: "bg-gradient-to-r from-warning/30 to-warning/70",
      text: "text-warning-fg/70",
    },
    {
      key: "5s-10s",
      label: "5s-10s",
      gradient: "bg-gradient-to-r from-danger/30 to-danger/70",
      text: "text-danger-fg/70",
    },
    {
      key: ">10s",
      label: ">10s",
      gradient: "bg-gradient-to-r from-danger/40 to-danger",
      text: "text-danger-fg",
    },
  ] as const;
        ...
        <div className="flex h-full flex-col justify-center gap-2">
          {barMeta.map((bar) => {
            ...
            return (
              ...
              >
                <span className="w-20 shrink-0 text-[10px] text-muted-foreground">{bar.label}</span>
